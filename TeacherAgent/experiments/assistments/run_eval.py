...
def main() -> None:
    ...
    out_dir = os.path.join(BENCH_ROOT, f"{timestamp}-fb-bkt-assistments{suffix}")
    ...
    manifest = {
        ...
        "dataSource": "SIMULATED (pipeline smoke)" if args.smoke else "ASSISTments 2009-2010 sparse subset",
    }
